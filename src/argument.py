...
# --------- default values ------------
  ...
  # No explicit 'loss_name' is maintained. The code will infer single vs hybrid at runtime
  # based on the number of configured loss components.
  if "loss" not in config.get("training", {}):
